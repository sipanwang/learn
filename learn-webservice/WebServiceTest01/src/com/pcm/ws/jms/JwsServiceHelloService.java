 ...
 * 
 */
@WebServiceClient(name = "JwsServiceHelloService", targetNamespace = "http://service.pcm.com/", wsdlLocation = "http://192.168.137.100:8080/Service/ServiceHello?wsdl")
public class JwsServiceHelloService extends Service {

	private final static URL JWSSERVICEHELLOSERVICE_WSDL_LOCATION;
	private final static Logger logger = Logger
			.getLogger(com.pcm.ws.jms.JwsServiceHelloService.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = com.pcm.ws.jms.JwsServiceHelloService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://192.168.137.100:8080/Service/ServiceHello?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://192.168.137.100:8080/Service/ServiceHello?wsdl', retrying as a local file");
